...
{
    BOOST_CHECK(TestSplitHost("www.federationcredit.org", "www.federationcredit.org", -1));
    BOOST_CHECK(TestSplitHost("[www.federationcredit.org]", "www.federationcredit.org", -1));
    BOOST_CHECK(TestSplitHost("www.federationcredit.org:80", "www.federationcredit.org", 80));
    BOOST_CHECK(TestSplitHost("[www.federationcredit.org]:80", "www.federationcredit.org", 80));
